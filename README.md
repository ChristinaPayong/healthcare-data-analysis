markdown# Healthcare Data Analysis — SQL
...
| Outil | Usage |
|---|---|
| SQL (MySQL) | Modélisation, requêtes analytiques, window functions |
| MySQL Workbench | Environnement de développement et visualisation du schéma |
| Schéma en étoile | Modélisation dimensionnelle |
| Vues SQL | Modularisation et réutilisation des requêtes |
| Sous-requêtes | Décomposition de requêtes complexes |
...
mysql -u root -p healthcare_db < sql/healthcare_analysis.sql
```

### 3. Explorer les requêtes

Ouvrir `sql/healthcare_analysis.sql` dans MySQL Workbench ou tout autre client SQL compatible MySQL.

## Auteure

**Christina Payong**
Étudiante ingénieure — Big Data & Machine Learning, EFREI Paris
